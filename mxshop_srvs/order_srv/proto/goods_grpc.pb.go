...
const (
	...
	Goods_NewHomeList_FullMethodName          = "/Goods/NewHomeList"
	Goods_HotHomeList_FullMethodName          = "/Goods/HotHomeList"
	Goods_SearchGoods_FullMethodName          = "/Goods/SearchGoods"
...
type GoodsClient interface {
	...
	// 主页面推荐接口
	NewHomeList(ctx context.Context, in *GoodsFilterRequest, opts ...grpc.CallOption) (*GoodsListResponse, error)
	HotHomeList(ctx context.Context, in *GoodsFilterRequest, opts ...grpc.CallOption) (*GoodsListResponse, error)
	// 搜索接口
	SearchGoods(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*GoodsListResponse, error)
...
func (c *goodsClient) NewHomeList(ctx context.Context, in *GoodsFilterRequest, opts ...grpc.CallOption) (*GoodsListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GoodsListResponse)
	err := c.cc.Invoke(ctx, Goods_NewHomeList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goodsClient) HotHomeList(ctx context.Context, in *GoodsFilterRequest, opts ...grpc.CallOption) (*GoodsListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GoodsListResponse)
	err := c.cc.Invoke(ctx, Goods_HotHomeList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goodsClient) SearchGoods(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*GoodsListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GoodsListResponse)
...
type GoodsServer interface {
	...
	// 主页面推荐接口
	NewHomeList(context.Context, *GoodsFilterRequest) (*GoodsListResponse, error)
	HotHomeList(context.Context, *GoodsFilterRequest) (*GoodsListResponse, error)
	// 搜索接口
	SearchGoods(context.Context, *SearchRequest) (*GoodsListResponse, error)
	// 现在用户提交订单有多个商品，你得批量查询商品的信息吧
...
func (UnimplementedGoodsServer) NewHomeList(context.Context, *GoodsFilterRequest) (*GoodsListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NewHomeList not implemented")
}
func (UnimplementedGoodsServer) HotHomeList(context.Context, *GoodsFilterRequest) (*GoodsListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HotHomeList not implemented")
}
func (UnimplementedGoodsServer) SearchGoods(context.Context, *SearchRequest) (*GoodsListResponse, error) {
...
func _Goods_NewHomeList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GoodsFilterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsServer).NewHomeList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Goods_NewHomeList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).NewHomeList(ctx, req.(*GoodsFilterRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Goods_HotHomeList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GoodsFilterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsServer).HotHomeList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Goods_HotHomeList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).HotHomeList(ctx, req.(*GoodsFilterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Goods_SearchGoods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).SearchGoods(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Goods_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NewHomeList",
			Handler:    _Goods_NewHomeList_Handler,
		},
		{
			MethodName: "HotHomeList",
			Handler:    _Goods_HotHomeList_Handler,
		},
		{
