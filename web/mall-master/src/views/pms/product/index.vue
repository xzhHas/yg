  ...
  <div class="app-container">
    ...
    <div class="pagination-container">
      <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
        layout="total, sizes,prev, pager, next,jumper" :page-size="goodsParams.pnum" :current-page.sync="goodsParams.pn"
        :total="total">
        <!-- :page-sizes="[5,10,15]" -->
      </el-pagination>
    </div>
...
export default {
  ...
  methods: {
    ...
    handleSizeChange(val) {
      ...
      this.goodsParams.pn = 1; // Reset to first page
      this.getList();
    },
    ...
    handlePublishStatusChange(paramname, index, row) {
      this.updatePublishStatus(paramname, !row[paramname], row);
    },
