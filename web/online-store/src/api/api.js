...
let goodsUrl = "http://192.168.3.152:8021/g"
let orderUrl = "http://192.168.3.152:8022/o"
let userUrl = "http://192.168.3.152:8024/u"
let userOpUrl = "http://192.168.3.152:8025/up"
export const ossUrl = "http://192.168.3.152:8023"
...
//获取商品新品列表
export const getNewHomeGoods = params => { return axios.get(`${goodsUrl}/v1/goods/new`, { params: params }) }

//获取热门搜索关键词
export const getHot = params => { return axios.get(`${goodsUrl}/v1/goods/hot`,{ params:params }) }

//搜索框 可以实现搜索功能，但是前端页面的显示，一直得不到处理（以后有机会解决这个问题）
// export const searchGo = params => { return axios.get(`${goodsUrl}/v1/goods/search`,{ params:params }) }
...
//修改收货地址
export const updateAddress = (addressId, params) => {return axios.put(`${userOpUrl}/v1/address/`+addressId, params)}
