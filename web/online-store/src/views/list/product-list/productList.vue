            ...
            <li v-for="item in listData" >
                <router-link :to="'/app/home/productDetail/'+item.id" class="productitem">
                    <span class="productimg">
                        <img width="150" height="150" :title="item.productname" :alt="item.productname" :src="item.front_image" style="display: block;">
                    </span>
                    <span class="nalaprice xszk">
                        <b>
                        ￥{{item.shop_price}}元  
                        </b>
                        <!-- 地址：views/list/product-list -->
                    </span>
                    <span class="productname">{{item.name}}</span>
                    <span class="description">简介：{{item.goods_brief}}</span>
                    <!-- <span class="market_pricce">{{item.market_pricce}}</span>  -->
