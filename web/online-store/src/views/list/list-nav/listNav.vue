<template>
    <div class="sidebar">
        <div class="cate-menu" id="cate-menu">
            ...
            <dl>
                <!-- <dt>前端地址：/views/list/list-nav</dt> -->
...
.here{padding:5px 0;color:#f0a6a6}
...
.cate-menu dl{border:1px solid #070707;padding:10px 0}
.cate-menu dt{font-size:14px;padding:5px 0 5px 12px;color:#000000}
.cate-menu dd a{display:block;padding:7px 0 7px 27px;background-color:#fff}
.cate-menu dd a:hover{background-color:#bdee6e;text-decoration:none}
.cate-menu dd a i{color:#c7f179;margin-left:5px}
.cate-menu dd.current a,.cate-menu dd.current a:hover{color:#0f0f0f;background-color:#f1f1f1}
