            ...
            <div class="box">
                <div class="box_1">
                    <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
                        ...
                        <div class="blank"></div>
                        <div width="100%" v-for="(item, index) in receiveInfoArr" :key="index"
                            :class="{ 'table-top': index > 0 }">
                            <div>
                                <div class="table-box">
                                    ...
                                    <div colspan="3" class="table-input" align="left" bgcolor="#ffffff">
                                        <div class="addr" @click="bubble(index)">
                                            <v-distpicker :province="item.province" :city="item.city"
                                                :area="item.district" @province="updateProvince" @city="updateCity"
                                                @area="updateArea"></v-distpicker>
                                        </div>
                                    </div>
                                </div>
                                <div class="table-box">
                                    <div align="right" class="table-label" bgcolor="#ffffff">收货人姓名：</div>
                                    <div align="left" class="table-input" bgcolor="#ffffff"><input name="consignee"
                                            type="text" class="inputBg" id="consignee_0" value="ssss"
                                            v-model="item.signer_name">
                                ...
                                <div class="table-box">
                                    ...
                                    <div align="left" class="table-input" bgcolor="#ffffff"><input name="address"
                                            type="text" class="inputBg" id="address_0" v-model="item.address">
                                        <span :class="{ error: item.address == '' }" class="must">(必填)</span>
                                    </div>
                                </div>
                                ...
                                <div class="table-box">
                                    ...
                                    <div align="left" class="table-input" bgcolor="#ffffff"><input name="mobile"
                                            type="text" class="inputBg" id="mobile_0" v-model="item.signer_mobile"><span
                                            :class="{ error: item.signer_mobile == '' }" class="must">(必填)</span></div>
                                </div>

                                <div class="table-center">
                                    <!-- <input type="submit" name="submit" class="bnt_blue_2" value="新增收货地址"> -->

                                    <button class="bnt_blue_2 btn-submit"
                                        @click="confirmUpdate(item.id, index)">确定修改</button>
                    ...
                    <div width="100%" class="table-top">
                        <div>
                            <div class="table-box">
                                ...
                                <div colspan="3" class="table-input" align="left" bgcolor="#ffffff">
                                    <div class="addr">
                                        ...
                                        <v-distpicker :province="newInfo.province" :city="newInfo.city"
                                            :area="newInfo.district" @province="getProvince" @city="getCity"
                                            @area="getArea"></v-distpicker>
                                    </div>
                                </div>
                            </div>
                            <div class="table-box">
                                ...
                                <div align="left" class="table-input" bgcolor="#ffffff"><input name="consignee"
                                        type="text" class="inputBg" id="consignee_0" value="ssss"
                                        v-model="newInfo.signer_name">
                                    <span :class="{ error: newInfo.signer_name == '' }" class="must">(必填)</span>
                                </div>
                            ...
                            <div class="table-box">
                                <div align="right" class="table-label" bgcolor="#ffffff">详细地址：</div>
                                <div align="left" class="table-input" bgcolor="#ffffff"><input name="address"
                                        type="text" class="inputBg" id="address_0" v-model="newInfo.address">
                                    <span :class="{ error: newInfo.address == '' }" class="must">(必填)</span>
                                </div>
                            </div>
                            <div class="table-box">

                                <div align="right" class="table-label" bgcolor="#ffffff">手机：</div>
                                <div align="left" class="table-input" bgcolor="#ffffff"><input name="mobile" type="text"
                                        class="inputBg" id="mobile_0" v-model="newInfo.signer_mobile"><span
                                        :class="{ error: newInfo.signer_mobile == '' }" class="must">(必填)</span></div>
                            </div>
                            <div class="table-center">
...
import { msg } from '../../../mock/mock/login';
export default {
    data() {
