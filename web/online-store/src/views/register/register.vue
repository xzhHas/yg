                    ...
                    <div class="tab-form">
                        <form id="mobile_register_form" autocomplete="off">
                            ...
                            <div class="form-group marb8">
                                <label>手&nbsp;机&nbsp;号</label>
                                <input id="jsRegMobile" name="account" v-model="mobile" type="text"
                            ...
                            <div class="clearfix">
                                ...
                                <input class="verify-code-btn sendcode" type="button" id="jsSendCode"
                                    @click="sendMessage" :value="getMessageText">
                            </div>
                            <p class="error-text marb8" v-show="error.code">{{ error.code }}</p>

                            <div class="form-group marb8">
                                <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                                <input id="jsPhoneRegPwd" name="password_m" type="password" v-model="password"
                            ...
                            <input class="btn btn-green" id="jsMobileRegBtn" @click="isRegister" type="button"
                                value="注册并登录">
                        </form>
                    </div>
        ...
        isRegister() {
            ...
            register({
                ...
                .catch(function (error) {
                    ...
                    that.error.code = error.error.code ? error.error.code : '';
                });
        },
        sendMessage() {
            var that = this;
