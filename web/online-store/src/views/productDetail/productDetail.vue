<template>
    <div>
       <current-loc :info="proDetail"></current-loc>
        <!--商品详情页上方-->
            ...
            <div class="detail_wrap">
                ...
                <div class="item-info" id="item-info">
                    <dl class="loaded">
                        ...
                        <p class="desc"> <span class="gray">简介：{{proDetail.goods_brief}}</span> </p>
                        </dt>
                        <dd class="property">
                            <ul>
                                ...
                                <li>
                                    <span class="lbl">销&nbsp;&nbsp;&nbsp;量</span><span>最近售出<em class="red">{{proDetail.sold_num}}</em>件</span>
                                </li>
                                <li>
                                    <span class="lbl">库&nbsp;&nbsp;&nbsp;存</span><span>仓库余量<em class="red">&nbsp;{{proDetail.stocks}}</em>件&nbsp;</span>
                                </li>
                                <li>
                                    <span class="lbl">收&nbsp;&nbsp;&nbsp;藏</span><span>客户收藏<em class="red">&nbsp;{{proDetail.fav_num}}&nbsp;</em>人</span>
                                </li>
                                <li>
                                    <span class="lbl">浏&nbsp;&nbsp;&nbsp;览</span><span>访问次数<em class="red">&nbsp;{{proDetail.click_num}}&nbsp;</em>次</span>
                                </li>
                            </ul>
                        </dd>
                        ...
                        <div class="product_tabs">
                            <div class="sectionbox z-box" id="spxqitem">
                                <div class="spxq_main">
                                    ...
                                    <div class="spxq_dec">
                                      <ul class="cle">
                                        <li v-for="(item,index) in proDetail.desc_images">
                                            <a>
                                                <img :src="item" alt="">
                                            </a>
                                        </li>
  ...
  export default {
    ...
    methods: {
          ...
          getGoodsDetail(this.productId)
            .then((response)=> {
                ...
                this.proDetail = response.data;
                 getCategory({id:response.data.category.id}).then((res)=> {
                     this.$set(this.proDetail,'category',res.data.name)
                    this.proDetail.parent_category = res.data.name
                  }).catch(function (error) {
                    console.log(error);
                  });
        ...
        addShoppingCart () { //加入购物车
            addShopCart({
                goods: Number(this.productId), // 商品id
